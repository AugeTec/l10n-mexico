# Copyright 2023 Auge Tec - Alexis Lopez Zubieta <alexis.lopez@augetec.com>
...
class ConceptoImpuestos(models.Model):
...
class ConceptoTraslados(models.Model):
...
class ConceptoTraslado(models.Model):
...
class ConceptoRetenciones(models.Model):
    """Nodo opcional para asentar los impuestos retenidos aplicables al
    presente concepto."""
...
class ConceptoInformacionAduanera(models.Model):
    ...
    l10n_mx_cfdi4_0_informacion_aduanera_concepto_id = fields.Many2one(
        comodel_name="l10n_mx_cfdi_spec.4_0.concepto",
        xsd_implicit=True,
        ondelete="cascade",
    )
    l10n_mx_cfdi4_0_informacion_aduanera_parte_id = fields.Many2one(
        comodel_name="l10n_mx_cfdi_spec.4_0.parte",
        xsd_implicit=True,
        ondelete="cascade",
    )
